...
SECRET_KEY = '3ujz^+2p=788lk9awik!5^k2b+tfa#x)8d3&0)$d-=mis3%u=q'
...
# 发送邮件的邮箱
EMAIL_HOST_USER = 'b1151418000@163.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'BKXZZNFVYPEGAZWE'
# 收件人看到的发件人
EMAIL_FROM = 'LH<b1151418000@163.com>'
